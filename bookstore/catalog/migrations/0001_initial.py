# Generated by Django 4.2 on 2025-09-24 14:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Дата обновления')),
                ('total_amount', models.DecimalField(decimal_places=2, max_digits=10, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Общая сумма')),
                ...
                ('delivery_method', models.CharField(choices=[('pickup', 'Самовывоз'), ('delivery', 'Курьерская доставка')], default='pickup', max_length=10, verbose_name='Способ доставки')),
